#https://raw.githubusercontent.com/dockerfile/java/master/oracle-java8/Dockerfile
#
...
#https://raw.githubusercontent.com/docker-library/tomcat/f6dc3671bf56465917b52c8df4356fa8f0ebafcd/7/jre8/Dockerfile
...
RUN set -x \
	...
	&& nativeBuildDeps=" \
		...
		make \
	" \
	&& apt-get update && apt-get install -y --no-install-recommends --allow-unauthenticated $nativeBuildDeps && rm -rf /var/lib/apt/lists/* \
	&& ( \
